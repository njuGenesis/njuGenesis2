...
public class HotspotPanel extends BgPanel{
	...
	public static void main(String[] args){
		...
		HotspotPanel p = new HotspotPanel("");
		f.add(p);
		f.setVisible(true);
...
//		downBt.setVisible(false);
		...
		bluePanel.setSize(980, 325);
		bluePanel.setLocation(10,0);
